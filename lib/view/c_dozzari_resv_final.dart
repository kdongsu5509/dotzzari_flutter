...
class DozzariResvFinal extends ConsumerStatefulWidget {
  const DozzariResvFinal({super.key});

  @override
  ConsumerState<DozzariResvFinal> createState() => _DozzariResvDetail2State();
}

class _DozzariResvDetail2State extends ConsumerState<DozzariResvFinal> {
    ...
    return DefaultLayout(
      ...
      child: Stack(
        children: [
          ...
          /**
           * 이거 아니라 탭바 넣는 것은 로직 상 될 수가 없다네요~
           */
          Positioned(
            bottom: 10,
            child: SizedBox(
